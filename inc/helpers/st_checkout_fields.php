    ...
    function st_checkout_fieldtype_text($field_name,$field)
    {
        ...
        <div class="col-sm-<?php echo esc_attr($size) ?>">
            ...
            <div class="form-group <?php if($icon){ echo 'form-group-icon-left';} ?>">
                ...
                <label><?php echo balanceTags($label) ?> <?php echo balanceTags($required) ?> </label>
                <input class="<?php echo implode(' ',$class) ?>" value="<?php echo esc_attr($value) ?>" name="<?php echo esc_attr($field_name) ?>" placeholder="<?php echo esc_attr($placeholder) ?>" type="text">
            </div>
    ...
    function st_checkout_fieldtype_textarea($field_name,$field)
    {
        ...
        <div class="col-sm-<?php echo esc_attr($size) ?>">
            ...
            <div class="form-group <?php if($icon){ echo 'form-group-icon-left';} ?>">
                ...
                <textarea <?php echo ($attrs_str)?> class="<?php echo implode(' ',$class) ?>"  name="<?php echo esc_attr($field_name) ?>" placeholder="<?php echo esc_attr($placeholder) ?>"><?php echo ($value)?></textarea>
            </div>
