 ...
 *
 */
if(!class_exists('STAdminFood'))
{

    class STAdminFood extends STAdmin
    {

        static $booking_page;

        protected $post_type="st_food";
        ...
        function __construct()
        {
            ...
            add_filter('manage_st_food_posts_columns', array($this,'add_col_header'), 10);
            add_action('manage_st_food_posts_custom_column', array($this,'add_col_content'), 10, 2);

            // ==========================================================================

            self::$booking_page=admin_url('edit.php?post_type=st_food&page=st_food_booking');
        ...
        function _init_post_type()
        {
            ...
            // Tours ==============================================================
            $labels = array(
                'name'               => __( 'Food', ST_TEXTDOMAIN ),
                'singular_name'      => __( 'Food', ST_TEXTDOMAIN ),
                'menu_name'          => __( 'Food', ST_TEXTDOMAIN ),
                'name_admin_bar'     => __( 'Food', ST_TEXTDOMAIN ),
                'add_new'            => __( 'Add New', ST_TEXTDOMAIN ),
                'add_new_item'       => __( 'Add New Food', ST_TEXTDOMAIN ),
                'new_item'           => __( 'New Food', ST_TEXTDOMAIN ),
                'edit_item'          => __( 'Edit Food', ST_TEXTDOMAIN ),
                'view_item'          => __( 'View Food', ST_TEXTDOMAIN ),
                'all_items'          => __( 'All Food', ST_TEXTDOMAIN ),
                'search_items'       => __( 'Search Food', ST_TEXTDOMAIN ),
                'parent_item_colon'  => __( 'Parent Food:', ST_TEXTDOMAIN ),
                'not_found'          => __( 'No Food found.', ST_TEXTDOMAIN ),
                'not_found_in_trash' => __( 'No Food found in Trash.', ST_TEXTDOMAIN )
            );
            ...
            $args = array(
                ...
                'show_ui'            => true,
                'query_var'          => true,
                'rewrite'            => array( 'slug' =>  get_option( 'food_permalink' ,'st_food' ) ),
            ...
            $labels = array(
                'name'                       => __( 'Cuisine Type', 'taxonomy general name', ST_TEXTDOMAIN ),
                'singular_name'              => __( 'Cuisine Type', 'taxonomy singular name', ST_TEXTDOMAIN ),
                'search_items'               => __( 'Search Cuisine Type' , ST_TEXTDOMAIN),
                'popular_items'              => __( 'Popular Cuisine Type' , ST_TEXTDOMAIN),
                'all_items'                  => __( 'All Cuisine Type', ST_TEXTDOMAIN ),
                'parent_item'                => null,
                'parent_item_colon'          => null,
                'edit_item'                  => __( 'Edit Cuisine Type' , ST_TEXTDOMAIN),
                'update_item'                => __( 'Update Cuisine Type' , ST_TEXTDOMAIN),
                'add_new_item'               => __( 'Add New Cuisine Feature', ST_TEXTDOMAIN ),
                'new_item_name'              => __( 'New Cuisine Type Name', ST_TEXTDOMAIN ),
                'separate_items_with_commas' => __( 'Separate Cuisine Type with commas' , ST_TEXTDOMAIN),
                'add_or_remove_items'        => __( 'Add or remove Cuisine Type', ST_TEXTDOMAIN ),
                'choose_from_most_used'      => __( 'Choose from the most used Cuisine Type', ST_TEXTDOMAIN ),
                'not_found'                  => __( 'No Cuisine Type.', ST_TEXTDOMAIN ),
                'menu_name'                  => __( 'Cuisine Type', ST_TEXTDOMAIN ),
            );
            $args = array(
                'hierarchical'          => true,
                'labels'                => $labels,
                ...
                'query_var'             => true,
                'rewrite'               => array( 'slug' => 'st_cuisine_type' ),
            );

            st_reg_taxonomy( 'st_cuisine_type', 'st_food', $args );

            $labels = array(
                'name'                       => __( 'Restaurent', 'taxonomy general name', ST_TEXTDOMAIN ),
                'singular_name'              => __( 'Restaurent', 'taxonomy singular name', ST_TEXTDOMAIN ),
                'search_items'               => __( 'Search Restaurent' , ST_TEXTDOMAIN),
                'popular_items'              => __( 'Popular Restaurent' , ST_TEXTDOMAIN),
                'all_items'                  => __( 'All Restaurent', ST_TEXTDOMAIN ),
                'parent_item'                => null,
                'parent_item_colon'          => null,
                'edit_item'                  => __( 'Edit Restaurent' , ST_TEXTDOMAIN),
                'update_item'                => __( 'Update Restaurent' , ST_TEXTDOMAIN),
                'add_new_item'               => __( 'Add New Restaurent Feature', ST_TEXTDOMAIN ),
                'new_item_name'              => __( 'New Restaurent Name', ST_TEXTDOMAIN ),
                'separate_items_with_commas' => __( 'Separate Restaurent with commas' , ST_TEXTDOMAIN),
                'add_or_remove_items'        => __( 'Add or remove Restaurent', ST_TEXTDOMAIN ),
                'choose_from_most_used'      => __( 'Choose from the most used Restaurent', ST_TEXTDOMAIN ),
                'not_found'                  => __( 'No Restaurent.', ST_TEXTDOMAIN ),
                'menu_name'                  => __( 'Restaurent', ST_TEXTDOMAIN ),
            );
            $args = array(
                'hierarchical'          => true,
                'labels'                => $labels,
                ...
                'show_admin_column'     => true,
                'query_var'             => true,
                'rewrite'               => array( 'slug' => 'st_restaurent_type' ),
            );
        ...
        function init_metabox()
        {
            ...
            $this->metabox[] = array(
                'id'          => 'room_metabox',
                'title'       => __( 'Restaurent Details', ST_TEXTDOMAIN),
                'desc'        => '',
                'pages'       => array( 'st_food' ),
                'context'     => 'normal',
                'priority'    => 'high',
                'fields'      => array(
                    ...
                    array(
                        ...
                        'desc'       => __( 'Select food images ', ST_TEXTDOMAIN),
                        'id'          => 'gallery',
                        'type'        => 'gallery',
                    ),
                    array(
                     ...
                     array(
                        ...
                        'id'          => 'website',
                        'type'        => 'text',
                        'desc'        => __( 'Website addresses', ST_TEXTDOMAIN),
                    ),
                    array(
                    ...
                    array(
                        ...
                        'choices'   =>array(
                            array(
                                'value'=>'group_price',
                                'label'=>__('Price / Group',ST_TEXTDOMAIN)
                            ),
                            array(
                                'value'=>'people_price',
        ...
        static function is_booking_page()
        {
            if(is_admin()
                ...
                and $_GET['post_type']=='st_food'
                and isset($_GET['page'])
                and $_GET['page']='st_food_booking'
            ) return true;
            return false;
        }
        ...
        {
            //Add booking page
            add_submenu_page('edit.php?post_type=st_food',__('Food Booking',ST_TEXTDOMAIN), __('Food Booking',ST_TEXTDOMAIN), 'manage_options', 'st_food_booking', array($this,'__food_booking_page'));
        }

        function  __food_booking_page(){
            ...
            if($section){
                ...
                echo balanceTags($this->load_view('food/booking_index',false));
            }
        ...
        function add_booking()
        {
            ...
            echo balanceTags($this->load_view('food/booking_edit',false,array('page_title'=>__('Add new Tour Booking',ST_TEXTDOMAIN))));
        }
        ...
        function tours_update_location($post_id)
        {
            ...
            if($post_type=='st_food')
            {
                ...
                if($query->have_posts()) {
                    ...
                    update_post_meta($location_id,'review_st_food',$total);
                    update_post_meta($location_id,'min_price_st_food',$price_min);
                    update_post_meta($location_id,'offer_st_food',$offer_tours);
                }
                wp_reset_postdata();
