 ...
 * @since 1.0
 *
 * Class STAdminRestaurent
 *
 * Created by ShineTheme
 *
 */
if (!class_exists('STAdminRestaurent')) {

    class STAdminRestaurent extends STAdmin
    {

        static $parent_key = 'Restaurent_parent';
        static $booking_page;
        protected $post_type='st_restaurent';
        ...
        function __construct()
        {
            ...
            self::$booking_page = admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking');


            //add colum for Restaurents
            add_filter('manage_Restaurent_Restaurent_posts_columns', array($this, 'add_col_header'), 10);
            add_action('manage_Restaurent_Restaurent_posts_custom_column', array($this, 'add_col_content'), 10, 2);

            //add colum for Restaurents
            add_filter('manage_st_restaurent_posts_columns', array($this, 'add_Restaurent_col_header'), 10);
            add_action('manage_st_restaurent_posts_custom_column', array($this, 'add_Restaurent_col_content'), 10, 2);
            ...
            add_action('wp_ajax_st_Restaurent_select_ajax', array(__CLASS__, 'st_Restaurent_select_ajax'));
        ...
        function init_post_type()
        {
            ...
            $labels = array(
                'name'               => __( 'Restaurents', ST_TEXTDOMAIN ),
                'singular_name'      => __( 'Restaurent Name', ST_TEXTDOMAIN ),
                'menu_name'          => __( 'Restaurents', ST_TEXTDOMAIN ),
                'name_admin_bar'     => __( 'Restaurent Name', ST_TEXTDOMAIN ),
                'add_new'            => __( 'Add New', ST_TEXTDOMAIN ),
                'add_new_item'       => __( 'Add New Restaurent', ST_TEXTDOMAIN ),
                'new_item'           => __( 'New Restaurent', ST_TEXTDOMAIN ),
                'edit_item'          => __( 'Edit Restaurent', ST_TEXTDOMAIN ),
                'view_item'          => __( 'View Restaurent', ST_TEXTDOMAIN ),
                'all_items'          => __( 'All Restaurents', ST_TEXTDOMAIN ),
                'search_items'       => __( 'Search Restaurents', ST_TEXTDOMAIN ),
                'parent_item_colon'  => __( 'Parent Restaurents:', ST_TEXTDOMAIN ),
                'not_found'          => __( 'No Restaurents found.', ST_TEXTDOMAIN ),
                'not_found_in_trash' => __( 'No Restaurents found in Trash.', ST_TEXTDOMAIN )
            );
            ...
            $args = array(
                ...
                'show_in_menu'       => true,
                'query_var'          => true,
                'rewrite'            => array( 'slug' => get_option( 'Restaurent_permalink' ,'st_restaurent' ) ),
            ...
            st_reg_post_type( 'st_restaurent', $args );

            $labels = array(
                'name'               => __( 'Restaurent(s)', ST_TEXTDOMAIN ),
                'singular_name'      => __( 'Restaurent', ST_TEXTDOMAIN ),
                'menu_name'          => __( 'Restaurent(s)', ST_TEXTDOMAIN ),
                'name_admin_bar'     => __( 'Restaurent', ST_TEXTDOMAIN ),
                'add_new'            => __( 'Add New', ST_TEXTDOMAIN ),
                'add_new_item'       => __( 'Add New Restaurent', ST_TEXTDOMAIN ),
                'new_item'           => __( 'New Restaurent', ST_TEXTDOMAIN ),
                'edit_item'          => __( 'Edit Restaurent', ST_TEXTDOMAIN ),
            ...
            $args = array(
                ...
                'publicly_queryable' => true,
                'show_ui'            => true,
                //'show_in_menu'       => 'edit.php?post_type=Restaurent',
                'query_var'          => true,
                'capability_type'    => 'post',
                'has_archive'        => true,
                'hierarchical'       => false,
            ...
            $name=__('Restaurent Type',ST_TEXTDOMAIN);
            $labels = array(
                'name'              => $name ,
                'singular_name'     => $name,
            ...
            $args = array(
                ...
                'labels'            => $labels,
                'show_ui'           =>true,
                'show_ui'           => 'edit.php?post_type=st_restaurent',
                'query_var'         => true,
            );

            st_reg_taxonomy('restaurent_type' ,'st_restaurent', $args );
          $name=__('Cuisine Type',ST_TEXTDOMAIN);
            $labels = array(
                'name'              => $name ,
                'singular_name'     => $name,
                'search_items'      => sprintf(__( 'Search %s' ,ST_TEXTDOMAIN),$name),
            ...
            st_reg_taxonomy('cuisine_type' ,'st_restaurent', $args );
        ...
        function init_metabox()
        {
            ...
            $this->metabox[] = array(
                'id'       => 'Restaurent_metabox',
                'title'    => __('Restaurent Information', ST_TEXTDOMAIN),
                'desc'     => '',
                'pages'    => array('st_restaurent'),
                'context'  => 'normal',
                'priority' => 'high',
                'fields'   => array(
                    array(
                        'label' => __('Restaurent Detail', ST_TEXTDOMAIN),
                        'id'    => 'detail_tab',
                        'type'  => 'tab'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'desc'  => __('Upload your Restaurent\'s logo; Recommend: 260px x 195px', ST_TEXTDOMAIN),
                    ),
                    array(
                    ...
                    array(
                        ...
                        'id'    => 'min_price',
                        'type'  => 'text',
                        'desc'  => __('Min price of this Restaurent', ST_TEXTDOMAIN),
                        'std'   => 0
                    ),
                    ...
                    array(
                        ...
                        'desc'      => __('Detail Restaurent Layout', ST_TEXTDOMAIN),
                        'type'      => 'select',
                        'choices'   => st_get_layout('st_restaurent')
                    ),

                    array(
                        'label' => __('Restaurent Email', ST_TEXTDOMAIN),
                        'id'    => 'email',
                        'type'  => 'text',
                        'desc'  => __('Restaurent Email Address, this address will received email when have new booking', ST_TEXTDOMAIN),
                    ),

                    array(
                        'label' => __('Restaurent Website', ST_TEXTDOMAIN),
                        'id'    => 'website',
                        'type'  => 'text',
                        'desc'  => __('Restaurent Website. Ex: <em>http://domain.com</em>', ST_TEXTDOMAIN),
                    ),
                    array(
                        'label' => __('Restaurent Phone', ST_TEXTDOMAIN),
                        'id'    => 'phone',
                        'type'  => 'text',
                        'desc'  => __('Restaurent Phone Number', ST_TEXTDOMAIN),
                    ),
                    array(
                        'label' => __('Fax Number', ST_TEXTDOMAIN),
                        'id'    => 'fax',
                        'type'  => 'text',
                        'desc'  => __('Restaurent Fax Number', ST_TEXTDOMAIN),
                    ),
                    ...
                    array(
                        ...
                        'id'    => 'gallery',
                        'type'  => 'gallery',
                        'desc'  => __('Pick your own image for this Restaurent', ST_TEXTDOMAIN),
                    ),
                    array(
                        'label' => __('Restaurent Video', ST_TEXTDOMAIN),
                        'id'    => 'video',
                        'type'  => 'text',
                    ...
                    array(
                        'label' => __('Restaurent Location', ST_TEXTDOMAIN),
                        'id'    => 'location_tab',
                        'type'  => 'tab'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'id'    => 'address',
                        'type'  => 'text',
                        'desc'  => __('Restaurent Address', ST_TEXTDOMAIN),
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type'  => 'text',
                        'desc'  => __('Total Number Booking of this Restaurent', ST_TEXTDOMAIN),
                        'std'   => 0
                    ),
                    ...
                    array(
                        ...
                        'id'    => 'Restaurent_options',
                        'type'  => 'tab'
                    ),
                    array(
                        'label'        => __('Booking Period', ST_TEXTDOMAIN),
                        'id'           => 'Restaurent_booking_period',
                        'type'         => 'numeric-slider',
                        'min_max_step' => '0,30,1',
                        'std'          => 0,
...
//            ),
        ...
        static function _update_avg_price($post_id = FALSE)
        {
            ...
            if ($post_type == 'st_restaurent') {
                $Restaurent_id = $post_id;
                $is_auto_caculate = get_post_meta($Restaurent_id, 'is_auto_caculate', TRUE);
                if ($is_auto_caculate != 'off') {
                    $query = array(
                        'post_type'      => 'Restaurent_Restaurent',
                        'posts_per_page' => 100,
                        'meta_key'       => 'Restaurent_parent',
                        'meta_value'     => $Restaurent_id
                    );
                    ...
                    if ($traver->post_count) {
                        ...
                        update_post_meta($Restaurent_id, 'price_avg', $avg_price);
                    }
                }
            }
        }
        ...
        static function  st_Restaurent_select_ajax()
        {
            ...
            query_posts(array('post_type' => $post_type, 'posts_per_page' => 10, 's' => $q, 'meta_key' => 'Restaurent_parent', 'meta_value' => $Restaurent_parent));
        ...
        static function is_booking_page()
        {
            if (is_admin()
                ...
                and $_GET['post_type'] == 'st_restaurent'
                and isset($_GET['page'])
                and $_GET['page'] = 'st_restaurent_booking'
            ) return TRUE;
        ...
        function add_menu_page()
        {
            ...
            add_submenu_page('edit.php?post_type=st_restaurent',__('Restaurent Bookings',ST_TEXTDOMAIN), __('Restaurent Bookings',ST_TEXTDOMAIN), 'manage_options', 'st_restaurent_booking', array($this,'__Restaurent_booking_page'));
        }

        function  __Restaurent_booking_page()
        {
            ...
            if ($section) {
                ...
                echo balanceTags($this->load_view('restaurent/booking_index', FALSE));
            }
        ...
        function add_booking()
        {
            ...
            echo balanceTags($this->load_view('Restaurent/booking_edit', FALSE, array('page_title' => __('Add new Restaurent Booking', ST_TEXTDOMAIN))));
        }
        ...
        function edit_order_item()
        {
            ...
            echo balanceTags($this->load_view('Restaurent/booking_edit'));
        }
        ...
        function add_col_header($defaults)
        {
            ...
            $this->array_splice_assoc($defaults,2,0,array('Restaurent_number'=>__('Restaurent(s)',ST_TEXTDOMAIN)));
            $this->array_splice_assoc($defaults,2,0,array('Restaurent_parent'=>__('Restaurent Name',ST_TEXTDOMAIN)));

            return $defaults;
        }

        function add_Restaurent_col_header($defaults)
        {
            $this->array_splice_assoc($defaults, 2, 0, array('Restaurent_layout' => __('Layout', ST_TEXTDOMAIN)));
        ...
        function add_col_content($column_name, $post_ID)
        {
            ...
            if ($column_name == 'Restaurent_parent') {
                // show content of 'directors_name' column
                $parent = get_post_meta($post_ID, 'Restaurent_parent', TRUE);
            ...
            if ($column_name == 'Restaurent_number') {
                echo get_post_meta($post_ID, 'number_Restaurent', TRUE);
            }
        }

        function add_Restaurent_col_content($column_name, $post_ID)
        {

            if ($column_name == 'Restaurent_layout') {
                // show content of 'directors_name' column
