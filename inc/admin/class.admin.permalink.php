...
if(!class_exists('STAdminPermalink')) {
    ...
    class STAdminPermalink extends STAdmin
    {
        ...
        public function settings() {
            ...
            $restaurent_permalink = get_option( 'restaurent_permalink' ,'st_restaurent' );
            ?>
            <table class="form-table">
                ...
                <tr>
                 ...
                 <tr>
                    <th><label><?php _e( 'Restaurent Custom Base', ST_TEXTDOMAIN ); ?></label></th>
                    <td>
                        <input name="restaurent_permalink" type="text" value="<?php echo esc_attr( $restaurent_permalink ); ?>" class="regular-text code">
                    </td>
                </tr>
                </tbody>
            </table>
