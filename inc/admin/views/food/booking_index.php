...
$data=STAdmin::get_history_bookings('st_food',$offset,$limit);
$posts=$data['rows'];
...
$paging['base']=admin_url('edit.php?post_type=st_food&page=st_food_booking%_%');
$paging['format']='&paged=%#%';
$paging['total']=$total;
$paging['current']=$page;
...
echo '<h2>'.__('Food Booking',ST_TEXTDOMAIN).'<a href="'.admin_url('edit.php?post_type=st_food&page=st_food_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';

    STAdmin::message();
?>
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_food&page=st_food_booking')?>" method="post">
    ...
    <table class="wp-list-table widefat fixed posts">
        <thead>
            <tr>
                ...
                <th class="manage-column">
                    <a href="#"><span><?php _e('Cuisine Type',ST_TEXTDOMAIN)?></span><span class="sorting-indicator"></span></a>
                </th>
                <th class="manage-column">
