                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        <input type="hidden" name="item_id" value="<?php echo get_post_meta($item_id,'item_id',true)?>" data-post-type="st_rental" class="form-control st_post_select_ajax " data-pl-name="<?php echo get_the_title(get_post_meta($item_id,'item_id',true)) ?>" >
                                    </div>
                                </div>
                                <div class="form-row">
