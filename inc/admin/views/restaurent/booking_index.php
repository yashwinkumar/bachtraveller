...
$data=STAdmin::get_history_bookings('st_restaurent',$offset,$limit);
$posts=$data['rows'];
...
$paging['base']=admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking%_%');
$paging['format']='&paged=%#%';
$paging['total']=$total;
$paging['current']=$page;

echo '<div class="wrap"><div id="icon-tools" class="icon32"></div>';
echo '<h2>'.__('Restaurent Bookings',ST_TEXTDOMAIN).'<a href="'.admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';

    STAdmin::message();
?>
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking')?>" method="get">
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking')?>" method="post">
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                <strong><a class="row-title"
                                           href="<?php echo admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"
                                           title=""><?php
                                ...
                                <div class="row-actions">
                                    <a href="<?php echo admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit',ST_TEXTDOMAIN)?></a> |
                                    <a href="<?php echo admin_url('edit.php?post_type=st_restaurent&page=st_restaurent_booking&section=resend_email&order_item_id=' . $post_id); ?>"><?php _e('Resend Email',ST_TEXTDOMAIN)?></a>
                                </div>
                            </td>
                            <td class="post-title page-title column-title">
