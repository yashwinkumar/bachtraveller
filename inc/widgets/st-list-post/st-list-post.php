            ...
            public function form( $instance ) {
                ...
                <p>
                    ...
                    <select name="<?php echo esc_attr($this->get_field_name( 'order' )); ?>">
                        <option <?php selected($orderby,"ASC");?> value="ASC"><?php echo __('ASC',ST_TEXTDOMAIN)?></option>
                        <option <?php selected($orderby,"DESC");?> value="DESC"><?php echo __('DESC',ST_TEXTDOMAIN)?></option>
