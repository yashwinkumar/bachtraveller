...
?>
    ...
    <div class="row">
        <div class="col-sm-6">
            <?php  echo do_shortcode('[vc_tabs][vc_tab title="Photos" tab_id="1418609998892-1-5" tab_icon="fa-camera"][st_food_detail_photo style="slide"][/vc_tab][vc_tab title="On the Map" tab_id="1418376646-2-22" tab_icon="fa-map-marker"][vc_column_text][st_food_detail_map][/vc_column_text][/vc_tab][/vc_tabs]');?>
