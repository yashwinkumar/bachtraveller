        ...
        <div class="row">
            <div class="col-xs-9">
                ...
                <p>
                    ...
                    <small><?php echo date(get_option('date_format'),strtotime($data['data']['check_in'])) ?>
                    <?php endif;?>
                    <?php if(isset($data['data']['check_out'])):?>
                    <?php st_the_language('to'); echo date(get_option('date_format'),strtotime($data['data']['check_out'])) ?>
                    <?php endif;?></small>
                </p>
            </div>
            <div class="col-xs-3">
